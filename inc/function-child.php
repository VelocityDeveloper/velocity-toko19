...
function velocitychild_theme_setup()
{
    if (class_exists('Kirki')) :
        ...
        Kirki::add_panel('panel_toko19', [
            'priority'    => 10,
            'title'       => esc_html__('Setting Toko 19', 'justg'),
        ...
        new \Kirki\Field\Text(
            [
                ...
                'label'       => esc_html__('Info Running Text', 'justg'),
                'description' => esc_html__('', 'justg'),
        ...
        new \Kirki\Field\Editor(
            [
                'settings'    => 'sambutan_home',
                'label'       => esc_html__('Sambutan Homepage', 'justg'),
                'description' => esc_html__('Isi kata sambutan', 'justg'),
                'section'     => 'section_sambutan',
                'default'     => '',
            ]
        );
        new \Kirki\Field\URL(
            [
                'settings' => 'link_testi',
                'label'    => esc_html__('Link Page Testimoni', 'justg'),
                'section'  => 'section_sambutan',
                'default'  => ' ',
                'priority' => 10,
            ]
...
{
    echo '<div class="px-2">';
    echo '<div class="card rounded-0 border-light border-top-0 border-bottom-0 shadow p-0 container">';
}
            ...
            <div class="p-3">
                ...
                <div class="row">
                    ...
                    <div class="col-6 p-1 text-end">
                        <span class="cart-arsip p-1 w-100 btn btn-sm bg-dark"><?php echo do_shortcode("[beli]"); ?></span>
                    </div>
                </div>
            </div>
        </div>
