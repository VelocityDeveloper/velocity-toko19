...
<article <?php post_class('p-md-2 p-2 mb-3'); ?> id="post-<?php the_ID(); ?>">
    <div class="row mx-0 py-2">
        <div class="col-md-2 p-md-0 p-0">
        ...
        <div class="col-md-10 p-md-2 py-2 px-0">
            ...
            <div class="post-info d-flex text-muted flex-wrap">
                <span class="p-1">
                ...
                <span class="p-1">
                    ...
                    foreach (get_the_terms(get_the_ID(), 'category') as $tax) {
                        echo '<a class="text-muted" href="' . get_term_link($tax->slug, 'category') . '">' . $tax->name . '</a>, ';
                    } ?>
                </span>
            </div>
